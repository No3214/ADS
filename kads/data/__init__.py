...
HOTEL = {
    ...
    "usps": [
        ...
        "Yeni Foça'ya yakın, sessiz ve özel",
    ],
...
RSA = {
    ...
    "NonBrand-Foca-Butik": {  # niyet: butik/tas/konak/koy oteli
        "final_url": "https://www.kozbeylikonagi.com/odalar",
        "path1": "Foca",
        "path2": "Butik-Otel",
        "headlines": [
            "Foça Butik Taş Otel",
            "Foça'da Taş Konak Oteli",
            "600 Yıllık Köy Konağı",
            "Otantik Foça Konaklama",
            "Kozbeyli Köyü Butik Otel",
            "Kozbeyli Konağı Foça",
            "Deniz Manzaralı Taş Oda",
            "Organik Köy Kahvaltısı",
            "Doğrudan Rezervasyon",
            "Komisyonsuz Otelden Fiyat",
            "Evcil Hayvan Dostu Otel",
            "Çatı Terasında Ege Keyfi",
            "16 Özel Tasarım Oda",
            "Yeni Foça'ya Yakın",
        ...
        "descriptions": [
            "Foça'da otantik taş konak oteli. 600 yıllık köyde 16 oda, doğrudan rezervasyon.",
            "Osmanlı taş mimarisinde 16 oda, deniz manzarası ve organik köy kahvaltısı.",
            "Çatı terasında Ege manzarası, Antakya sofrası, pişi ve dibek kahvesi.",
            "Evcil dostlarınız ücretsiz. Sessizlik, miras ve zarafet bir arada.",
        ],
    },
    "NonBrand-Foca-Genel": {  # niyet: foca otel/konaklama/manzara/balayi/evcil
        "final_url": "https://www.kozbeylikonagi.com/odalar",
        "path1": "Foca",
        "path2": "Konaklama",
        "headlines": [
            "Foça'da Konaklama",
            "Foça Deniz Manzaralı Otel",
            "Foça Hafta Sonu Kaçamağı",
            "Foça Balayı Konağı",
            "Evcil Dostu Foça Oteli",
            "Kozbeyli Konağı Foça",
            "600 Yıllık Köyde Huzur",
            "Organik Köy Kahvaltısı",
            "Doğrudan & Komisyonsuz",
        ...
        "descriptions": [
            "Foça'da deniz manzaralı, evcil dostu konaklama. Doğrudan otelden rezerve edin.",
            "Osmanlı taş mimarisinde 16 oda, deniz manzarası ve organik köy kahvaltısı.",
            "Çatı terasında Ege manzarası, Antakya sofrası, pişi ve dibek kahvesi.",
            "Hafta sonu ve balayı için sessiz, özel kaçış. Komisyon ödemeyin.",
        ],
    },
    "NonBrand-Niche": {  # niyet: izmir tas konak/koy kahvaltisi/doga/sakin kacis
        "final_url": "https://www.kozbeylikonagi.com/odalar",
        "path1": "Foca",
        "path2": "Koy-Konak",
        "headlines": [
            "İzmir Taş Konak Oteli",
            "İzmir Butik Köy Oteli",
            "Ege Köy Kahvaltısı Konağı",
            "Sakin Doğa Kaçışı",
            "600 Yıllık Köyde Huzur",
            "Kozbeyli Konağı Foça",
            "Deniz Manzaralı Taş Oda",
        ...
        "descriptions": [
            "İzmir/Foça'da taş konak deneyimi: köy kahvaltısı, doğa, sessizlik. Komisyonsuz.",
            "Osmanlı taş mimarisinde 16 oda, deniz manzarası ve organik köy kahvaltısı.",
            "Çatı terasında Ege manzarası, Antakya sofrası, pişi ve dibek kahvesi.",
            "Doğa ve sakinlik arayanlara. Evcil dostlarınız ücretsiz kabul edilir.",
        ],
    },
}
...
META_COPY = {
    "Konsept1-TasKonak": {
        ...
        "description": "Yeni Foça'ya yakın, doğrudan rezervasyon.",
        "cta": "Book Now",
