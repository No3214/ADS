# 7 Gün + 30 Gün AEO Planı

## 7 gün (hızlı düzeltme)
1. Render + WAF kontrolü (GPTBot/OAI-SearchBot/PerplexityBot 429/403 dönüyor mu? engel YOKSA dokunma).
2. Hotel JSON-LD ana sayfaya (aeo/schema/HotelSchema.tsx).
3. FAQPage /sss'e (görünür sorularla birebir).
4. HotelRoom + Breadcrumb → 7 oda sayfasına.
...
## Eşikler
- 5 şema Rich Results Test'ten hatasız. · Yeni sayfalar GSC'de indeksli. · ≥1 AI platformunda alıntı.
